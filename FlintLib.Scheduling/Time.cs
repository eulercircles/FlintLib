...
namespace FLib.Scheduling
{
	public struct Time
	{
		...
		public Time(int hour, int minute, int second)
		{
			...
			{ throw new ArgumentOutOfRangeException(nameof(hour), string.Format(fMessage_ValueMustBeBetween, MIN_VALUE, MAX_HOURS)); }
			if (minute < MIN_VALUE || minute > MAX_MINUTES)
			{ throw new ArgumentOutOfRangeException(nameof(minute), string.Format(fMessage_ValueMustBeBetween, MIN_VALUE, MAX_MINUTES)); }
			if (second < MIN_VALUE || second > MAX_SECONDS)
			{ throw new ArgumentOutOfRangeException(nameof(hour), string.Format(fMessage_ValueMustBeBetween, MIN_VALUE, MAX_SECONDS)); }
